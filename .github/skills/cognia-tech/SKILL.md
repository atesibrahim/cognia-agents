...
Record the profile in `{project_name}-technical-analysis.md` **Section 10 — Technology Profile** (see Output Format).
...
- **Known Vulnerabilities**: OWASP Top 10 mapping against  code
...
###  Architecture Report (_analysis.md)
```markdown
#  Architecture Report
...
### Validation
- [ ] Findings reviewed with at least 1 senior developer from  team
